...
#     ''' Non-UTF-8 content that fails UTF-8 decode returns charset. '''
#     with patch( 'chardet.detect' ) as mock_chardet:
...
#
#
# def test_350_non_textual_mimetype_returns_without_charset( 
#         detection_module ):
...
#     # This triggers validation path at line 125 in 
...
#
# def test_600_non_textual_mimetype_ignores_invalid_charset( 
#         detection_module ):
