...
''' Centralized test content patterns for systematic testing. '''
...
DECODE_FAILURE_LATIN1 = b'\xff\xfe\xfd'  # Invalid for most charsets
...
UNICODE_HEAVY = ( 'Test with unicode: ' + '🌟' * 100 ).encode( 'utf-8' )
